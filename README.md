...
game**. [mdr-navi-i18n](https://github.com/caribbeansc/mdr-navi-i18n) does
the same for メダロットnavi (GBA), Medarot 9 (3DS) is about 60% translated,
and once the series is covered the plan is to move on to other sagas that
never received a translation.
